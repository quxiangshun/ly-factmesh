...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'admin/roles', name: 'AdminRoles', component: Placeholder, meta: { title: '角色管理', desc: '角色 CRUD、分配权限' } },
      { path: 'admin/permissions', name: 'AdminPermissions', component: Placeholder, meta: { title: '权限管理', desc: '权限 CRUD、权限树' } },
      { path: 'admin/dicts', name: 'AdminDicts', component: Placeholder, meta: { title: '字典管理', desc: '数据字典维护' } },
      { path: 'admin/configs', name: 'AdminConfigs', component: Placeholder, meta: { title: '系统配置', desc: '系统参数配置' } },
