...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'admin/tenants', name: 'AdminTenants', component: () => import('../views/TenantsView.vue'), meta: { title: '租户管理' } },
      { path: 'admin/operation-logs', name: 'AdminOperationLogs', component: () => import('../views/OperationLogsView.vue'), meta: { title: '操作日志' } },
      { path: 'admin/audit-logs', name: 'AdminAuditLogs', component: () => import('../views/AuditLogsView.vue'), meta: { title: '审计日志' } },
      ...
      { path: 'wms/requisitions', name: 'WmsRequisitions', component: () => import('../views/RequisitionsView.vue'), meta: { title: '领料单', desc: '生产领料/退料（MES 联动）' } },
      { path: 'wms/inventory', name: 'WmsInventory', component: () => import('../views/InventoryView.vue'), meta: { title: '库存管理', desc: '库存查询、预警、盘点' } },
      { path: 'wms/trace', name: 'WmsTrace', component: () => import('../views/WmsTraceView.vue'), meta: { title: '物料追溯', desc: '按物料/批次/工单/领料单追溯' } },
      { path: 'qms/inspection-tasks', name: 'QmsInspectionTasks', component: () => import('../views/InspectionTasksView.vue'), meta: { title: '质检任务' } },
      { path: 'qms/inspection-results', name: 'QmsInspectionResults', component: () => import('../views/InspectionResultsView.vue'), meta: { title: '质检结果', desc: '检验项录入与质量判定' } },
      { path: 'qms/ncr', name: 'QmsNcr', component: () => import('../views/NcrView.vue'), meta: { title: '不合格品处理' } },
      ...
      { path: 'ops/system-events', name: 'OpsSystemEvents', component: () => import('../views/OpsSystemEventsView.vue'), meta: { title: '系统事件', desc: '系统级事件' } },
